...
public class GLText {
    ...
    public GLText(GLGraphics graphics, AssetManager assets) {
        this.gl = graphics.getGL();                     // Save the GL10 Instance
        this.assets = assets;                           // Save the Asset Manager Instance

        batch = new SpriteBatcher( graphics,CHAR_BATCH_SIZE );  // Create Sprite Batch (with Defined Size)
    ...
    public void end()  {
        batch.endBatch("Text Class");                               // End Batch
    ...
    public void drawTexture(int width, int height)  {
        ...
        batch.endBatch("DrawTexture");     // End Batch
    }
