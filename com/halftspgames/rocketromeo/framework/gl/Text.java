...
/**
 * Created by mareenator on 4/2/15.
 */
public class Text{
    ...
    public Text(GLGraphics graphics, AssetManager assets) {
        this.gl = graphics.getGL();                     // Save the GL10 Instance
        this.assets = assets;                           // Save the Asset Manager Instance

        batch = new SpriteBatcher( graphics,500 );  // Create Sprite Batch (with Defined Size)
